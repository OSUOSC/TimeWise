...
#endif
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            if (ImGui::BeginPopupModal("Stacked 1"))
            {
                ...
                ImGui::ListBox("Hour", &currentHour, hours, IM_ARRAYSIZE(hours), 4); ImGui::PushItemWidth(40); ImGui::SameLine();
                for (int i = 0; i < 60; i++) {
                    char* minuteStr = new char[3];
                    snprintf(minuteStr, 3, "%02d", i);
                    minutes[i] = minuteStr;
                }
                ImGui::ListBox("Minute", &currentMinute, minutes, IM_ARRAYSIZE(minutes), 4); ImGui::PushItemWidth(40); ImGui::SameLine();
                // AM/PM Picker
